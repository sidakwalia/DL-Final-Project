...
def create_dataset_by_split(args, split, is_train=True, sampling=True):
    ...
    if sampling:
        ...
        indices = list(range(0, len_dataset, sample_rate))
...
def create_downstream_dataset(args, is_eval=False):
    if is_eval:
        ...
        return \
            create_dataset_by_split(args, split="train", is_train=True, sampling=True), \
            create_dataset_by_split(args, split="val", is_train=True, sampling=False)

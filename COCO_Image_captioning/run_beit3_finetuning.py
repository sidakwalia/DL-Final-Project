...
def main(args, ds_init):
    ...
    params_to_train = ["layer_norm", "mlm_head"]
    ...
    params_to_train = ["mlm_head.bias","mlm_head.weight"]
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        if data_loader_val is not None:
            if args.task not in ["coco_captioning", "nocaps"]:
                ...
                print(f'Prediction file is {prediction_file} and result file is {result_file}')
                task_key = "CIDEr"
